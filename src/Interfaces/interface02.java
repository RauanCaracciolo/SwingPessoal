...
public class interface02 extends JFrame implements ActionListener {
    ...
    public interface02() {
        ...
        add(botaoSair);
        setVisible(true);
        botaoEnviar.addActionListener(this::formulaTeste);
    }

    private void formulaTeste(ActionEvent actionEvent) {
        double velocidade = Double.parseDouble(areaVelocidade.getText());
